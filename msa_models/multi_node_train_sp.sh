...
# DATADIR=/data0/Databases/GOA-S2F/data-netgo # for netgo
DATADIR=/data0/Databases/GOA-S2F/data-sp # for swissprot
# DATE=24-12-20
# DATE=25-03-26
# DATE=25-04-02
# DATE=25-07-05
...
torchrun \
    ...
    scripts/construct_gendis.py -c configs/training_msa-v1/${ONT}-${DATE}.yml \
    $DATADIR/dataset_state_ind_dict.pkl \
    $DATADIR/MSAs \
    $DATADIR/training/trained_model/sp-v1-${DATE}/${ONT}
